...
impl TextInput {
    ...
    pub fn left(&mut self, _: &super::Left, _: &mut Window, cx: &mut Context<Self>) {
    ...
    pub fn right(&mut self, _: &super::Right, _: &mut Window, cx: &mut Context<Self>) {
        if self.selected_range.is_empty() {
    ...
    pub fn select_left(&mut self, _: &super::SelectLeft, _: &mut Window, cx: &mut Context<Self>) {
        self.select_to(self.previous_boundary(self.cursor_offset()), cx);
    }

    pub fn select_right(&mut self, _: &super::SelectRight, _: &mut Window, cx: &mut Context<Self>) {
        self.select_to(self.next_boundary(self.cursor_offset()), cx);
    }

    pub fn select_all(&mut self, _: &super::SelectAll, _: &mut Window, cx: &mut Context<Self>) {
        self.move_to(0, cx);
        self.select_to(self.content.len(), cx)
    }

    pub fn home(&mut self, _: &super::Home, _: &mut Window, cx: &mut Context<Self>) {
        self.move_to(0, cx);
    }
    ...
    pub fn delete(&mut self, _: &super::Delete, window: &mut Window, cx: &mut Context<Self>) {
        if self.selected_range.is_empty() {
            self.select_to(self.next_boundary(self.cursor_offset()), cx)
        }
        self.replace_text_in_range(None, "", window, cx)
    ...
    pub fn paste(&mut self, _: &super::Paste, window: &mut Window, cx: &mut Context<Self>) {
        if let Some(text) = cx.read_from_clipboard().and_then(|item| item.text()) {
            self.replace_text_in_range(None, &text.replace("\n", " "), window, cx);
        }
    }

    pub fn copy(&mut self, _: &super::Copy, _: &mut Window, cx: &mut Context<Self>) {
        if !self.selected_range.is_empty() {
    ...
    pub fn cut(&mut self, _: &super::Cut, window: &mut Window, cx: &mut Context<Self>) {
        if !self.selected_range.is_empty() {
            cx.write_to_clipboard(ClipboardItem::new_string(
                (&self.content[self.selected_range.clone()]).to_string(),
            ));
